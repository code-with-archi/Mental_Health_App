...
import BASE_URL from '../../config'; // ✅ import backend base URL
...
export default function Signup() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // ✅ use BASE_URL instead of hardcoded localhost:8000
        ...
        <div className="flex min-h-screen flex-1 flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div className="w-screen mt-20">
                ...
                >
                    ...
                    <div
                        className="mt-12 flex items-center justify-center gap-x-6 bg-white py-4"
                        style={{ background: 'linear-gradient(to right, #D1D5DB, #E5E7EB, #F3F4F6)' }}
                    >
